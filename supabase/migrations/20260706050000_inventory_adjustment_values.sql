drop function if exists public.api_admin_get_inventory_adjustments_period(text, timestamp with time zone, timestamp with time zone);
drop function if exists public.admin_get_inventory_adjustments_period(timestamp with time zone, timestamp with time zone);
drop function if exists public.get_inventory_adjustments_period(timestamp with time zone, timestamp with time zone);
