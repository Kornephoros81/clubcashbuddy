alter table public.products
  add column if not exists mhd_sale_enabled boolean not null default false;
...
revoke all on function public.admin_create_product(text, integer, integer, text, boolean, boolean, integer, boolean) from public;
revoke all on function public.admin_update_product(uuid, text, integer, integer, text, boolean, boolean, integer, boolean) from public;
revoke all on function public.api_admin_create_product(text, text, integer, integer, text, boolean, boolean, integer, boolean) from public;
revoke all on function public.api_admin_update_product(text, uuid, text, integer, integer, text, boolean, boolean, integer, boolean) from public;
